...
<div class="row t30">
   ...
   <div class="small-3 columns" style="text-align: left;">
      ...
      <p style="font-size: 14px">초기에 필요한 서버 및 스토리지 용량 만으로 구성하고, 새로운 카메라 및 데이터가 추가/증가함에 따라 언제든 서버를 추가하여 온라인 확장할 수 있습니다. </p>
   </div>
</div>
...
<div class="row t30">
   ...
   <div class="small-3 columns" style="text-align: left;">
      ...
      <p style="font-size: 14px">비디오 감시 워크로드의 요구사항을 처리할 수 있도록 고성능의 스토리지 제공, GPU 지원, 고대역의 네트워크를 제공합니다. </p>
   </div>
</div>
...
<div class="row t30">
   <div class="small-3 columns" style="text-align: left;">
      <p style="font-size: 15px"><b>모든 앱을 위한 단일 플랫폼</b></p>
...
<div class="row t30">
   <div class="small-3 columns" style="text-align: left;">
      <p style="font-size: 15px"><b>모니터링을 통한 가시성 확보</b></p>
